    ...
    makeRequest(host, port, path, method, headers, requestData, protocol, timeout) {
        ...
        const requestPromise = new Promise((resolve, reject) => {
            ...
            req.setTimeout(timeout, () => {
                const timeoutError = HttpClient_js_1.HttpClient.makeTimeoutError();
    ...
    toJSON() {
        return new Promise((resolve, reject) => {
            ...
            this._res.once('error', (error) => {
                reject(HttpClient_js_1.HttpClient.makeResponseBodyError(error));
            });
            ...
            this._res.once('close', () => {
                if (!this._res.complete) {
                    reject(HttpClient_js_1.HttpClient.makeResponseBodyError(null));
                }
            });
            this._res.once('end', () => {
                try {
