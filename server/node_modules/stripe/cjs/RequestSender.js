...
class RequestSender {
    ...
    _jsonResponseHandler(requestEvent, apiMode, usage, timeout, requestRetries, callback) {
        return (res) => {
            ...
            res
                ...
                if (e instanceof HttpClient_js_1.HttpClientResponseBodyError &&
                    e.code === HttpClient_js_1.HttpClient.TIMEOUT_ERROR_CODE) {
    ...
    requestId) {
        ...
        return new Error_js_1.StripeConnectionError({
    ...
    _request(method, host, path, data, authenticator, options, usage = [], callback, requestDataProcessor = null) {
        ...
        (0, utils_js_1.validatePath)(path);
