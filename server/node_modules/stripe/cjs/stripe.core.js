...
class Stripe {
    ...
    _buildEventNotification(parsed) {
        ...
        parsed.fetchEvent = () => {
            ...
            `/v2/core/events/${encodeURIComponent(parsed.id)}`, undefined, {
    ...
    notificationHandlerWithoutVerification(fallbackCallback) {
        return StripeEventNotificationHandler_js_1.StripeEventNotificationHandler.withoutVerification(this, fallbackCallback);
    }
}
