...
exports.StripeEventNotificationHandlerWithoutVerification = exports.StripeEventNotificationHandler = void 0;
...
class BaseEventNotificationHandler {
    ...
    on(type, callback) {
        ...
        if (this.registeredHandlers[type]) {
            throw new Error(`Callback for event type "${type}" is already registered.`);
        }
    ...
    assertCanRegister() {
        if (this.hasHandledEvent) {
            throw new Error('Cannot register new callbacks after an event has been handled. This is indicative of a bug.');
        }
    }
    /**
...
class StripeEventNotificationHandler extends BaseEventNotificationHandler {
 ...
 */
class StripeEventNotificationHandlerWithoutVerification extends BaseEventNotificationHandler {
    async handle(rawBody) {
        this.hasHandledEvent = true;
        return await this.dispatchEvent(this.client.parseEventNotificationWithoutVerification(rawBody));
    }
}
exports.StripeEventNotificationHandlerWithoutVerification = StripeEventNotificationHandlerWithoutVerification;
