...
import { MetadataParam, OtherString, Emptyable, AddressParam, ShippingAddressParam, PaginationParams, Metadata, Address } from '../shared.js';
...
export declare namespace Source {
    ...
    type Type = 'ach_credit_transfer' | 'ach_debit' | 'acss_debit' | 'alipay' | 'au_becs_debit' | 'bancontact' | 'card' | 'card_present' | 'eps' | 'giropay' | 'ideal' | 'klarna' | 'multibanco' | 'p24' | 'sepa_credit_transfer' | 'sepa_debit' | 'sofort' | 'three_d_secure' | 'wechat' | OtherString;
    interface Wechat {
        prepay_id?: string;
...
export declare namespace SourceCreateParams {
    type Flow = 'code_verification' | 'none' | 'receiver' | 'redirect' | OtherString;
    interface Mandate {
        /**
    ...
    type Usage = 'reusable' | 'single_use' | OtherString;
    namespace Mandate {
        ...
        type Interval = 'one_time' | 'scheduled' | 'variable' | OtherString;
        type NotificationMethod = 'deprecated_none' | 'email' | 'manual' | 'none' | 'stripe_email' | OtherString;
        namespace Acceptance {
            ...
            type Status = 'accepted' | 'pending' | 'refused' | 'revoked' | OtherString;
            type Type = 'offline' | 'online' | OtherString;
        }
    }
    namespace Receiver {
        type RefundAttributesMethod = 'email' | 'manual' | 'none' | OtherString;
    }
    namespace SourceOrder {
        interface Item {
            amount?: number;
        ...
        namespace Item {
            type Type = 'discount' | 'shipping' | 'sku' | 'tax' | OtherString;
        }
    }
}
