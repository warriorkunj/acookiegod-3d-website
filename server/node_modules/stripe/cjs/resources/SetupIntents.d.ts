...
export declare namespace SetupIntent {
    ...
    type CancellationReason = 'abandoned' | 'duplicate' | 'requested_by_customer' | OtherString;
    ...
    type Status = 'canceled' | 'processing' | 'requires_action' | 'requires_confirmation' | 'requires_payment_method' | 'succeeded' | OtherString;
