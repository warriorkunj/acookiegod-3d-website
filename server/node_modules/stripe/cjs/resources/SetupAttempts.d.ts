    ...
    namespace PaymentMethodDetails {
        ...
        namespace Card {
            ...
            namespace Wallet {
                ...
                type Type = 'apple_pay' | 'google_pay' | 'link' | OtherString;
            }
        }
        ...
        namespace Ideal {
            ...
            type Bic = 'ABNANL2A' | 'ADYBNL2A' | 'ASNBNL21' | 'BITSNL2A' | 'BUNQNL2A' | 'BUUTNL2A' | 'FNOMNL22' | 'FVLBNL22' | 'HANDNL2A' | 'INGBNL2A' | 'KNABNL2H' | 'MLLENL2A' | 'MOYONL21' | 'NNBANL2G' | 'NTSBDEB1' | 'RABONL2U' | 'RBRBNL21' | 'REVOIE23' | 'REVOLT21' | 'SNSBNL2A' | 'TRIONL2U' | OtherString;
        }
        namespace Sofort {
            type PreferredLanguage = 'de' | 'en' | 'fr' | 'nl' | OtherString;
        }
