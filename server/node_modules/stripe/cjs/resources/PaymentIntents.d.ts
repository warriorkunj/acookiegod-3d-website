...
export declare namespace PaymentIntent {
    ...
    type CancellationReason = 'abandoned' | 'automatic' | 'duplicate' | 'expired' | 'failed_invoice' | 'fraudulent' | 'requested_by_customer' | 'void_invoice' | OtherString;
    ...
    type Status = 'canceled' | 'processing' | 'requires_action' | 'requires_capture' | 'requires_confirmation' | 'requires_payment_method' | 'succeeded' | OtherString;
    ...
    namespace PaymentMethodOptions {
        ...
        namespace Card {
            ...
            type Network = 'amex' | 'cartes_bancaires' | 'diners' | 'discover' | 'eftpos_au' | 'girocard' | 'interac' | 'jcb' | 'link' | 'mastercard' | 'unionpay' | 'unknown' | 'visa' | OtherString;
            ...
            namespace MandateOptions {
                ...
                type Interval = 'day' | 'month' | 'sporadic' | 'week' | 'year' | OtherString;
            }
        }
...
export declare namespace PaymentIntentCreateParams {
    ...
    type OffSession = 'one_off' | 'recurring' | OtherString;
    interface PaymentDetails {
        /**
         * A unique value to identify the customer. This field is available only for card payments.
         *
    ...
    namespace MandateData {
        ...
        namespace CustomerAcceptance {
            ...
            type Type = 'offline' | 'online' | OtherString;
        }
    }
    namespace PaymentMethodData {
        ...
        namespace Eps {
            type Bank = 'arzte_und_apotheker_bank' | 'austrian_anadi_bank_ag' | 'bank_austria' | 'bankhaus_carl_spangler' | 'bankhaus_schelhammer_und_schattera_ag' | 'bawag_psk_ag' | 'bks_bank_ag' | 'brull_kallmus_bank_ag' | 'btv_vier_lander_bank' | 'capital_bank_grawe_gruppe_ag' | 'deutsche_bank_ag' | 'dolomitenbank' | 'easybank_ag' | 'erste_bank_und_sparkassen' | 'hypo_alpeadriabank_international_ag' | 'hypo_bank_burgenland_aktiengesellschaft' | 'hypo_noe_lb_fur_niederosterreich_u_wien' | 'hypo_oberosterreich_salzburg_steiermark' | 'hypo_tirol_bank_ag' | 'hypo_vorarlberg_bank_ag' | 'marchfelder_bank' | 'oberbank_ag' | 'raiffeisen_bankengruppe_osterreich' | 'schoellerbank_ag' | 'sparda_bank_wien' | 'volksbank_gruppe' | 'volkskreditbank_ag' | 'vr_bank_braunau' | OtherString;
        }
        namespace Fpx {
            type AccountHolderType = 'company' | 'individual' | OtherString;
            type Bank = 'affin_bank' | 'agrobank' | 'alliance_bank' | 'ambank' | 'bank_islam' | 'bank_muamalat' | 'bank_of_china' | 'bank_rakyat' | 'bnp_paribas' | 'bsn' | 'cimb' | 'citibank' | 'deutsche_bank' | 'hong_leong_bank' | 'hsbc' | 'kfh' | 'maybank2e' | 'maybank2u' | 'mbsb_bank' | 'ocbc' | 'pb_enterprise' | 'public_bank' | 'rhb' | 'standard_chartered' | 'uob' | OtherString;
        }
        namespace Ideal {
            type Bank = 'abn_amro' | 'adyen' | 'asn_bank' | 'bunq' | 'buut' | 'finom' | 'handelsbanken' | 'ing' | 'knab' | 'mollie' | 'moneyou' | 'n26' | 'nn' | 'rabobank' | 'regiobank' | 'revolut' | 'sns_bank' | 'triodos_bank' | 'van_lanschot' | 'yoursafe' | OtherString;
        }
        namespace Klarna {
            interface Dob {
                /**
    ...
    namespace PaymentMethodOptions {
        ...
        namespace UsBankAccount {
            ...
            namespace Networks {
                type Requested = 'ach' | 'us_domestic_wire' | OtherString;
            }
        }
        namespace WechatPay {
            type Client = 'android' | 'ios' | 'web' | OtherString;
...
export declare namespace PaymentIntentCancelParams {
    type CancellationReason = 'abandoned' | 'duplicate' | 'fraudulent' | 'requested_by_customer' | OtherString;
}
