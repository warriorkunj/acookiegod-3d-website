...
function validatePath(path) {
    if (typeof path !== 'string' ||
        !path.startsWith('/') ||
        path.startsWith('//')) {
        throw new Error(`Request path must be a string beginning with a single "/", got: ${JSON.stringify(path)}`);
    }
}
