...
import { HttpClient, HttpClientResponseBodyError, HttpClientRuntimeError, } from './net/HttpClient.js';
import { validatePath, jsonStringifyRequestData, normalizeHeaders, queryStringifyRequestData, removeNullish, getAPIMode, parseHttpHeaderAsString, processOptions, } from './utils.js';
export class RequestSender {
        ...
        return (res) => {
            ...
            res
                ...
                if (e instanceof HttpClientResponseBodyError &&
                    ...
                    throw RequestSender._generateConnectionError(e, timeout, requestRetries, requestId);
                }
    ...
    static _generateConnectionError(error, timeout, requestRetries, 
            ...
            authenticator(request)
                ...
                req
                    ...
                    if (RequestSender._shouldRetry(res, requestRetries, maxRetries)) {
                        ...
                        return this._jsonResponseHandler(requestEvent, apiMode, usage, timeout, requestRetries, callback)(res);
                    }
                })
                    .catch((error) => {
                    ...
                    if (RequestSender._shouldRetry(null, requestRetries, maxRetries, error)) {
                        ...
                        return callback(RequestSender._generateConnectionError(error, timeout, requestRetries));
                    }
                });
            })
                .catch((e) => {
