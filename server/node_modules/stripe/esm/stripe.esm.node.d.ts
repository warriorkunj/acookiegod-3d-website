...
import { FallbackCallback, StripeEventNotificationHandler, StripeEventNotificationHandlerWithoutVerification, UnhandledNotificationDetails } from './StripeEventNotificationHandler.js';
...
export declare class Stripe {
    ...
    parseEventNotification(payload: WebhookPayload, header: WebhookHeader, secret: string, tolerance?: number, cryptoProvider?: CryptoProvider, receivedAt?: number): V2.Core.EventNotification;
    parseEventNotificationAsync(payload: WebhookPayload, header: WebhookHeader, secret: string, tolerance?: number, cryptoProvider?: CryptoProvider, receivedAt?: number): Promise<V2.Core.EventNotification>;
    /**
     ...
     * or [Azure Event Grid](https://docs.stripe.com/event-destinations/eventgrid) envelope.
     */
    parseEventNotificationWithoutVerification(payload: WebhookPayload): V2.Core.EventNotification;
    notificationHandler(webhookSecret: string, fallbackCallback: FallbackCallback): StripeEventNotificationHandler;
    notificationHandlerWithoutVerification(fallbackCallback: FallbackCallback): StripeEventNotificationHandlerWithoutVerification;
}
