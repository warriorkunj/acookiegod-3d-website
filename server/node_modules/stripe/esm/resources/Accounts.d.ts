...
export declare namespace Account {
    ...
    namespace Capabilities {
        type AcssDebitPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type AffirmPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type AfterpayClearpayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type AlmaPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type AmazonPayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type AppDistribution = 'active' | 'inactive' | 'pending' | OtherString;
        type AuBecsDebitPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type BacsDebitPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type BancontactPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type BankTransferPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type BilliePayments = 'active' | 'inactive' | 'pending' | OtherString;
        type BizumPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type BlikPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type BoletoPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type CardIssuing = 'active' | 'inactive' | 'pending' | OtherString;
        type CardPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type CartesBancairesPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type CashappPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type CryptoPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type EpsPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type FpxPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type GbBankTransferPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type GiropayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type GrabpayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type IdealPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type IndiaInternationalPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type JcbPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type JpBankTransferPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type KakaoPayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type KlarnaPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type KonbiniPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type KrCardPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type LegacyPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type LinkPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type MbWayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type MobilepayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type MultibancoPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type MxBankTransferPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type NaverPayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type NzBankAccountBecsDebitPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type OxxoPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type P24Payments = 'active' | 'inactive' | 'pending' | OtherString;
        type PayByBankPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type PaycoPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type PaynowPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type PaytoPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type PixPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type PromptpayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type RevolutPayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type SamsungPayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type SatispayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type ScalapayPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type SepaBankTransferPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type SepaDebitPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type SofortPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type SunbitPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type SwishPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type TaxReportingUs1099K = 'active' | 'inactive' | 'pending' | OtherString;
        type TaxReportingUs1099Misc = 'active' | 'inactive' | 'pending' | OtherString;
        type Transfers = 'active' | 'inactive' | 'pending' | OtherString;
        type Treasury = 'active' | 'inactive' | 'pending' | OtherString;
        type TwintPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type UpiPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type UsBankAccountAchPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type UsBankTransferPayments = 'active' | 'inactive' | 'pending' | OtherString;
        type ZipPayments = 'active' | 'inactive' | 'pending' | OtherString;
    }
    namespace Company {
    ...
    namespace Controller {
        ...
        type Type = 'account' | 'application' | OtherString;
        namespace Fees {
...
export declare namespace AccountCreateParams {
    ...
    type Type = 'custom' | 'express' | 'standard' | OtherString;
    namespace BusinessProfile {
        interface AnnualRevenue {
            /**
             * A non-negative integer representing the amount in the [smallest currency unit](https://docs.stripe.com/currencies#zero-decimal).
    ...
    namespace Settings {
        ...
        namespace Payouts {
            ...
            namespace Schedule {
                ...
                type WeeklyAnchor = 'friday' | 'monday' | 'saturday' | 'sunday' | 'thursday' | 'tuesday' | 'wednesday' | OtherString;
                type WeeklyPayoutDay = 'friday' | 'monday' | 'thursday' | 'tuesday' | 'wednesday' | OtherString;
            }
        }
        namespace Treasury {
...
export declare namespace AccountListExternalAccountsParams {
    type Object = 'bank_account' | 'card' | OtherString;
}
...
export declare namespace AccountUpdateExternalAccountParams {
    type AccountHolderType = 'company' | 'individual' | OtherString;
    type AccountType = 'checking' | 'futsu' | 'savings' | 'toza' | OtherString;
    interface Documents {
        /**
