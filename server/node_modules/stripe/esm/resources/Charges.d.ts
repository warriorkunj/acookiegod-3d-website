...
import { Emptyable, MetadataParam, AddressParam, OtherString, PaginationParams, RangeQueryParam, Metadata, Address } from '../shared.js';
...
export declare namespace Charge {
    ...
    namespace Outcome {
        type AdviceCode = 'confirm_card_data' | 'do_not_try_again' | 'try_again_later' | OtherString;
        interface Rule {
            /**
    ...
    namespace PaymentMethodDetails {
        ...
        namespace Card {
            ...
            namespace Wallet {
                ...
                type Type = 'amex_express_checkout' | 'apple_pay' | 'google_pay' | 'link' | 'masterpass' | 'samsung_pay' | 'visa_checkout' | OtherString;
...
export declare namespace ChargeUpdateParams {
    ...
    namespace FraudDetails {
        type UserReport = 'fraudulent' | 'safe' | OtherString;
    }
}
