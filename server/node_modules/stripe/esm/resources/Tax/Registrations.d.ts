...
export declare namespace Registration {
    ...
    namespace CountryOptions {
        ...
        namespace Us {
            ...
            type Type = 'local_amusement_tax' | 'local_lease_tax' | 'mass_transit_parking_tax' | 'parking_tax' | 'state_communications_tax' | 'state_retail_delivery_fee' | 'state_sales_tax' | OtherString;
